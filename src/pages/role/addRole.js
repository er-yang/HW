    ...
    this.refs.form.validateAll((errors, values) => {
      if (errors) {
       console.log('errors', errors); 
        ...
        axios({
          url: 'http://localhost:8080/role/save',
          method: 'post',
          data: values
        }).then((response) => {
          if (response.data) {
        ...
        >
          <div style={styles.formContent}>
            ...
            <Row style={styles.formItem}>
              ...
              <Col span="10">
                <IceFormBinder name="roleName" required message="必填">
            ...
            <Row style={styles.formItem}>
              ...
              <Col span="10">
                <IceFormBinder name="roleCode" required message="必填">
                  <Input size="large" placeholder="请输入权限编号" />
                </IceFormBinder>
                <IceFormError name="roleCode" />
              </Col>
            </Row>
           <Row style={styles.formItem}>
              <Col span="3" style={styles.formLabel}>
